...
{
	[TestFixture]
	public class Question_2_Object_initialiser
	{
		...
		{
			var loan = new BookLoan {MemberName = "Jill", DueDate = new DateTime(2100, 12, 31)};
		...
		{
			var loan = new BookLoan {MemberName = "Jill", DueDate = new DateTime(2000, 12, 31)};
		...
		{
			var loan = new BookLoan {MemberName = "Jill"};
